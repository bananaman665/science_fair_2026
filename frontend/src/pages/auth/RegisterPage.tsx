      ...
      <div className="flex-1 flex flex-col bg-gradient-to-b from-blue-500 to-blue-400 overflow-y-auto">
        ...
        <div className="flex-1 flex items-start justify-center px-4 pb-8">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 text-center">
            ...
            <Link to="/login" className="block w-full py-3 px-4 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-full transition text-center">
              Return to Login
            </Link>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-start justify-center px-4 pb-8">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900">Create Your<br />Account Now!</h2>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-white text-sm text-gray-600">Or Sign up with</span>
            </div>
          </div>
          ...
          <p className="text-center text-gray-700 mt-8">
            ...
            <Link to="/login" className="font-semibold text-blue-500 hover:text-blue-600 transition">
              Sign in
            </Link>
          </p>
        </div>
